...
// ==================================================
					...
					)
	{
		...
		cudaMalloc((void**) &dev_inputMatConv, bytesMat);
		...
		/**** EXERCICE 2 ****/
		convolution<<< dim3(blockSize_x, blockSize_y), dim3(gridSize_x, gridSize_y) >>>(dev_inputImg, dev_inputMatConv, dev_output, imgWidth, imgHeight, matSize);
